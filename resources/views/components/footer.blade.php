<div id="contact_us">
    <div class="flex flex-col lg:flex-row justify-around bg-white lg:h-[40vh] px-4 lg:px-20 py-5 mb-32 mt-10 lg:mt-40">
        <div>
        ...
        <div>
            ...
            <div class="mt-10 sm:flex sm:flex-row items-center sm:justify-around lg:flex-col lg:items-start">
                ...
                <div class="mt-6 ">
                    ...
                    <p class="font-bold text-pink-950 text-lg">admin@gazellefinance.com</p>

                    <div class="mt-6">
                        <span>for Armenia:</span>
                        <p class="font-bold text-pink-950 text-lg">armenia@gazellefinance.com </p>
                    </div>
    ...
    <div class="lg:mt-10 text-center mb-2 text-pink-950 ">© 2024, Gazelle Finance, All rights reserved</div>
</div>
