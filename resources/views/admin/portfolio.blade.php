...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    <div id="kt_content_container" class="container-fluid">
        <div class="card">
            ...
            <div class="card-header border-0 pt-6">
                <button type="button" class="btn btn-primary mb-4" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer">Add new portfolio</button>
            </div>
                                ...
                                <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true"
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <input type="text" class="form-control form-control-solid"
                                               placeholder="Enter portfolio title" name="name" required />
                                    </div>
                                    ...
                                    <div class="fv-row mb-7">
                                        <label class="required fs-6 fw-bold mb-2">Industry</label>
                                        <input type="text" class="form-control form-control-solid"
                                               placeholder="Enter industry" name="industry" required />
                                    </div>
                                    ...
                                    <div class="fv-row mb-7">
                                        <label class="required fs-6 fw-bold mb-2">Web-site</label>
                                        <input type="text" class="form-control form-control-solid"
                                               placeholder="Enter Web-site" name="website" required />
                                    </div>

                                    <div class="fv-row mb-10 images">
                                        <label class="required fs-6 fw-bold mb-2">Logo</label>
                                        <div>
                                            <input class="pictures required" type="file" name="logo" accept="image" required>
                                        </div>
                                    </div>
