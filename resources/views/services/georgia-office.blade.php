<x-layout>
    ...
    <div class="p-6 lg:p-10">
        <h1 class="text-2xl md:text-4xl text-center mt-2">{{__('services.our')}} <span class="font-bold text-pink-950">{{__('services.offices')}}</span></h1>
        ...
        <div class="flex flex-col-reverse xl:flex-row justify-around space-y-3 xl:space-y-0 xl:space-x-10 mt-12">
            ...
            <div class="xl:w-1/2 shadow-2xl px-10 py-1 bg-gray-50 ">
                <h1 class="uppercase text-xl font-bold text-pink-950 text-uppercase">{{__('services.please_contact')}}:</h1>
                <div class="space-y-1">
                    <p class="text-xl font-bold text-pink-950 leading-7 mt-10">{{__('services.georgia')}}</p>
                    <p class="text-sm  mt-10 italic">- {{__('services.melikishvili')}}</p>
                ...
                <div class="space-y-1">
                    <p class="text-xl font-bold text-pink-950 leading-7 mt-10">{{__('services.armenia')}}</p>
                    <p class="text-sm  mt-10 italic">- {{__('services.teryan')}}</p>
