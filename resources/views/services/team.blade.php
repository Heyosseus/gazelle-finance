<x-layout>
    ...
    <div class="p-8 lg:p-16 flex flex-col xl:flex-row justify-between space-y-5 xl:space-x-5 ">
        ...
        <div class="w-full flex flex-col ">
            <h1 class="text-4xl  py-4 text-center">{{__('services.our')}} <span class="font-bold text-pink-950">{{__('services.team')}} </span></h1>
            <div class="w-20 h-px bg-gray-300 text-center mx-auto"></div>

            <p class="mt-6 text-center mx-auto w-full lg:w-1/2">{{__('services.about_team')}} </p>
        </div>
    </div>
