<div class="flex flex-col items-center justify-center mt-12">
    ...
    <div class="flex flex-wrap justify-center p-4 lg:p-20">
        @foreach ($articles as $blog)

        <div class="w-full md:w-1/2 lg:w-1/3 p-4">
            <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                <img src="{{$blog->photo}}" alt="" class="w-full h-64  object-fill rounded-t-lg cursor-pointer hover:scale-110 transition duration-500">
                <div class="p-6">
